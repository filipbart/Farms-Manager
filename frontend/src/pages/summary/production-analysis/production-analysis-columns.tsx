  ...
  return [
    ...
    },
    {
      ...
      cellClassName: (params) =>
        getCellClassName(params, columnStats.combinedAvgWeight, false),
    },
    {
    ...
    },
    {
      ...
      valueGetter: (value: any) => (value ? `${value.toFixed(2)}%` : ""),
      cellClassName: (params) =>
        getCellClassName(params, columnStats.deadPctCycle, true),
    },
    {
      ...
      valueGetter: (value: any) => (value ? `${value.toFixed(2)}%` : ""),
      cellClassName: (params) =>
        getCellClassName(params, columnStats.defectivePctCycle, true),
    },
    {
      ...
      valueGetter: (value: any) => (value ? `${value.toFixed(2)}%` : ""),
      cellClassName: (params) =>
        getCellClassName(params, columnStats.deadAndDefectivePctCycle, true),
    },
    ...
    },
    {
      ...
      width: 130,
      cellClassName: (params) =>
        getCellClassName(params, columnStats.fcrWithLosses, true),
    },
    {
      ...
      width: 140,
      cellClassName: (params) =>
        getCellClassName(params, columnStats.fcrWithoutLosses, true),
    },
    {
      field: "points",
      headerName: "Punkty",
    ...
    },
    {
      ...
      type: "number",
      width: 100,
      cellClassName: (params) => getCellClassName(params, columnStats.eww, false),
    },
