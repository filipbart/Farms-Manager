export default class ApiUrl {
  ...
  public static UpdateAvatar = this.User + "/avatar";
  public static ChangeNotificationFarms = this.User + "/notification-farms";
  ...
  public static DashboardCharts = this.Dashboard + "/charts";
  ...
  public static SummaryFinancialAnalysis = this.Summary + "/financial-analysis";
