...
public class FallenStockRepository : AbstractRepository<FallenStockEntity>, IFallenStockRepository
{
    private readonly FarmsManagerContext _context;
    public IUnitOfWork UnitOfWork => _context;

    public FallenStockRepository(FarmsManagerContext context, IConfigurationProvider configurationProvider) : base(
