...
{
    /// <inheritdoc />
    public partial class AddProductionDataFailureEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "production_data_failure",
                ...
                columns: table => new
                {
                    ...
                    defective_count = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_production_data_failure", x => x.id);
                    table.ForeignKey(
                        name: "fk_production_data_failure_cycle_cycle_id",
                        column: x => x.cycle_id,
                    ...
                    table.ForeignKey(
                        name: "fk_production_data_failure_farm_farm_id",
                        column: x => x.farm_id,
                        principalSchema: "farms_manager",
                        principalTable: "farm",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_production_data_failure_henhouse_henhouse_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_production_data_failure_farm_id",
                schema: "farms_manager",
                table: "production_data_failure",
                column: "farm_id");

            migrationBuilder.CreateIndex(
                name: "ix_production_data_failure_henhouse_id",
                schema: "farms_manager",
                table: "production_data_failure",
                column: "henhouse_id");
        }
