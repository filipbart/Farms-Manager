...
namespace FarmsManager.Infrastructure.Migrations
{
    ...
    [Migration("20251216171449_AdjustKsefInvoiceEntity")]
    partial class AdjustKsefInvoiceEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FarmsManager.Domain.Aggregates.AccountingAggregate.Entities.KSeFInvoiceEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_k_se_f_invoice");

                    b.HasIndex("AssignedCycleId")
                        .HasDatabaseName("ix_k_se_f_invoice_assigned_cycle_id");

                    b.HasIndex("AssignedUserId")
                        .HasDatabaseName("ix_k_se_f_invoice_assigned_user_id");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("ix_k_se_f_invoice_created_by");

                    b.HasIndex("DeletedBy")
                        .HasDatabaseName("ix_k_se_f_invoice_deleted_by");

                    b.HasIndex("InvoiceDate")
                        .HasDatabaseName("ix_k_se_f_invoice_invoice_date");

                    b.HasIndex("InvoiceNumber")
                        .HasDatabaseName("ix_k_se_f_invoice_invoice_number");

                    b.HasIndex("KSeFNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_k_se_f_invoice_k_se_f_number");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_k_se_f_invoice_modified_by");

                    b.ToTable("k_se_f_invoice", "farms_manager");
                });
            ...
            modelBuilder.Entity("FarmsManager.Domain.Aggregates.AccountingAggregate.Entities.KSeFSynchronizationLogEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_k_se_f_synchronization_log");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("ix_k_se_f_synchronization_log_created_by");

                    b.HasIndex("DeletedBy")
                        .HasDatabaseName("ix_k_se_f_synchronization_log_deleted_by");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_k_se_f_synchronization_log_modified_by");

                    b.HasIndex("StartedAt")
                        .IsDescending()
                        .HasDatabaseName("ix_k_se_f_synchronization_log_started_at");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_k_se_f_synchronization_log_status");

                    b.ToTable("k_se_f_synchronization_log", "farms_manager");
                });
            ...
            modelBuilder.Entity("FarmsManager.Domain.Aggregates.ExpenseAggregate.Entities.UserExpenseAdvanceColumnSettingsEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("VisibleColumns")
                        ...
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("visible_columns");

                    b.HasKey("Id")
                        .HasName("pk_user_expense_advance_column_settings");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("ix_user_expense_advance_column_settings_created_by");

                    b.HasIndex("DeletedBy")
                        .HasDatabaseName("ix_user_expense_advance_column_settings_deleted_by");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_user_expense_advance_column_settings_modified_by");
                    ...
                    b.ToTable("user_expense_advance_column_settings", "farms_manager");
                });
            ...
            modelBuilder.Entity("FarmsManager.Domain.Aggregates.AccountingAggregate.Entities.KSeFSynchronizationLogEntity", b =>
                {
                    b.HasOne("FarmsManager.Domain.Aggregates.UserAggregate.Entities.UserEntity", "Creator")
                        ...
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_k_se_f_synchronization_log_user_entity_created_by");

                    b.HasOne("FarmsManager.Domain.Aggregates.UserAggregate.Entities.UserEntity", "Deleter")
                        .WithMany()
                        .HasForeignKey("DeletedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_k_se_f_synchronization_log_user_entity_deleted_by");

                    b.HasOne("FarmsManager.Domain.Aggregates.UserAggregate.Entities.UserEntity", "Modifier")
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_k_se_f_synchronization_log_user_entity_modified_by");
            ...
            modelBuilder.Entity("FarmsManager.Domain.Aggregates.ExpenseAggregate.Entities.UserExpenseAdvanceColumnSettingsEntity", b =>
                {
                    b.HasOne("FarmsManager.Domain.Aggregates.UserAggregate.Entities.UserEntity", "Creator")
                        ...
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_user_expense_advance_column_settings_user_created_by");

                    b.HasOne("FarmsManager.Domain.Aggregates.UserAggregate.Entities.UserEntity", "Deleter")
                        .WithMany()
                        .HasForeignKey("DeletedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_user_expense_advance_column_settings_user_deleted_by");

                    b.HasOne("FarmsManager.Domain.Aggregates.UserAggregate.Entities.UserEntity", "Modifier")
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_user_expense_advance_column_settings_user_modified_by");
                    ...
                    b.HasOne("FarmsManager.Domain.Aggregates.UserAggregate.Entities.UserEntity", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_expense_advance_column_settings_user_entity_user_id");
