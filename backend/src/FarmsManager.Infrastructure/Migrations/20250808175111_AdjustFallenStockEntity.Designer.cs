...
namespace FarmsManager.Infrastructure.Migrations
{
    ...
    [Migration("20250808175111_AdjustFallenStockEntity")]
    partial class AdjustFallenStockEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmsManager.Domain.Aggregates.FallenStockAggregate.Entities.FallenStockEntity", b =>
                {
                    ...
                    b.Property<Guid>("InternalIrzGroupId")
                        .HasColumnType("uuid")
                        .HasColumnName("internal_irz_group_id");
                    ...
                    b.HasIndex("CycleId", "FarmId", "HenhouseId", "UtilizationPlantId")
                        .IsUnique()
                        .HasDatabaseName("ix_fallen_stock_cycle_id_farm_id_henhouse_id_utilization_plant")
            ...
            modelBuilder.Entity("FarmsManager.Domain.Aggregates.HatcheryAggregate.Entities.HatcheryPriceEntity", b =>
                {
                    b.HasOne("FarmsManager.Domain.Aggregates.HatcheryAggregate.Entities.HatcheryEntity", "Hatchery")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_hatchery_price_hatchery_hatchery_id");
