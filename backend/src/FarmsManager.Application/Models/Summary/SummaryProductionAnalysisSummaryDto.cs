...
/// <summary>
/// Model sumy dla analizy produkcyjnej - zawiera sumy dla wszystkich kolumn liczbowych
/// </summary>
public class SummaryProductionAnalysisSummaryDto
{
    ...
    /// <summary>Masa sprzedanych ptaków Ubojnia sprzedaż całkowita [kg]</summary>
    public decimal? TotalSaleSoldWeight { get; set; }
    
    /// <summary>Śr. Masa ciała sprzedanych ptaków sprzedaż całkowita [kg]</summary>
    public decimal? TotalSaleAvgWeight { get; set; }
    ...
    public int? TotalSaleSettlementCount { get; set; }
    ...
    public decimal? DefectivePctCycle { get; set; }
    
    /// <summary>% sztuk padłych i wybrakowanych z cyklu produkcyjnego</summary>
    public decimal? DeadAndDefectivePctCycle { get; set; }
    ...
    /// <summary>Zużycie gazu na 1m2 powierzchni [L/m2]</summary>
    public decimal? GasConsumptionPerM2 { get; set; }
    
    /// <summary>Bilans sztuk na koniec cyklu</summary>
    public int? EndCycleBirdBalance { get; set; }
}
