...
public record SummaryProductionAnalysisQueryFilters : OrderedPaginationParams {
...
public record SummaryProductionAnalysisQuery(SummaryProductionAnalysisQueryFilters Filters)
